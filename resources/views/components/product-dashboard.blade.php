                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="p-4">COGS</th>
                    ...
                    <tbody>
                        @forelse ($products as $product)
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    Rp {{ number_format($product->overhead_cost, 0, ',', '.') }}
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <button type="button"
                                            data-drawer-target="drawer-read-product-advanced-{{ $product->id }}"
                                            data-drawer-show="drawer-read-product-advanced-{{ $product->id }}"
                                            aria-controls="drawer-read-product-advanced-{{ $product->id }}"
                            ...
                            {{-- <x-create-product-model :product="$product"></x-create-product-model> --}}

                            {{-- <x-update-drawer :product="$product"></x-update-drawer> --}}

                            {{-- <x-preview-drawer :product="$product"></x-preview-drawer> --}}
